...
TaskMaker.make_task 'bundler', CommandVersionDetector::Bundler.version do |task_maker|
...
TaskMaker.make_task 'rake', CommandVersionDetector::Rake.version do |task_maker|
