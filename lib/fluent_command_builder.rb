...
require File.expand_path(File.dirname(__FILE__) + '/fluent_command_builder/command_builders/security.rb')
...
require File.expand_path(File.dirname(__FILE__) + '/fluent_command_builder/command_builders/tf.rb')
