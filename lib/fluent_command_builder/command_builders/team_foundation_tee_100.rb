  ...
  module TeamFoundationTEE
    module V100
      ...
      def self.version_validator
        @version_validator ||= VersionValidator.new(FluentCommandBuilder::TeamFoundationTEE::COMMAND_NAME, FluentCommandBuilder::TeamFoundationTEE.version_detector, exact_version)
      end
