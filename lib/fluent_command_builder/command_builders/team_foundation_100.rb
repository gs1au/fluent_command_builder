  ...
  module TeamFoundation
    module V100
      ...
      def self.version_validator
        @version_validator ||= VersionValidator.new(FluentCommandBuilder::TeamFoundation::COMMAND_NAME, FluentCommandBuilder::TeamFoundation.version_detector, exact_version)
      end
